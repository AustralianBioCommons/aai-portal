...
describe('RegisterSuccessComponent', () => {
  ...
  it('should display thank you heading and verification message', () => {
    ...
    expect(normalizedText).toContain(
      `Thank you! We've sent a verification email to galaxy.user@example.com. Please open that email and click the link inside to finish setting up your account and log in.`,
    );
  });
});
